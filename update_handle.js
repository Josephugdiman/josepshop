...
// Replace handleUpdateVendor
const marker = '  const handleUpdateVendor = async () => {';
const nextFuncMarker = '  const handleRenewVendor';

const startIndex = content.indexOf(marker);
const endIndex = content.indexOf(nextFuncMarker, startIndex);
